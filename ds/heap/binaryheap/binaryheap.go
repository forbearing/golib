...
// func down[E any](h []E, i int, less func(E, E) bool) {
// 	for {
// 		// 计算左右子节点的索引
// 		left, right := 2*i+1, 2*i+2
//
// 		// 如果左子节点超出范围，说明已经到底
// 		if left >= len(h) || left < 0 { // left < 0 检查是防止整数溢出
// 			break
// 		}
//
// 		// 找出左右子节点中较小的那个
...
// 			j = right // 如果右子节点存在且更小，更新j
// 		}
//
// 		// 如果当前节点已经小于等于最小的子节点，满足堆性质，退出
// 		if !less(h[j], h[i]) {
// 			break
// 		}
//
...
// }
//
// func up[E any](h []E, i int, less func(E, E) bool) {
// 	for {
// 		// 计算父节点索引
// 		parent := (i - 1) / 2
//
// 		// 如果已经到达根节点，或当前节点不小于父节点，退出
