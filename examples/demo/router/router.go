...
func Init() error {
	...
	router.Register[*env.File, *env.File, *env.File](router.Auth(), "config/namespaces/:ns/apps/:app/envs/:env/files/:filename", &types.ControllerConfig[*env.File]{ParamName: "filename"}, consts.Delete)
	router.Register[*env.File, *env.File, *env.File](router.Auth(), "config/namespaces/:ns/apps/:app/envs/:env/files/:filename", &types.ControllerConfig[*env.File]{ParamName: "filename"}, consts.Update)
	router.Register[*env.File, *env.File, *env.File](router.Auth(), "config/namespaces/:ns/apps/:app/envs/:env/files/:filename", &types.ControllerConfig[*env.File]{ParamName: "filename"}, consts.Patch)
	...
	router.Register[*env.File, *env.File, *env.File](router.Auth(), "config/namespaces/:ns/apps/:app/envs/:env/files/:filename", &types.ControllerConfig[*env.File]{ParamName: "filename"}, consts.Get)
