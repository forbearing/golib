...
func TestParse(t *testing.T) {
	tests := []struct {
			...
			want: map[string]*Design{
				"User": {
					...
					Routes: map[string][]*Action{
						"iam/users": {
							{Enabled: true, Service: false, Payload: "*UserReq", Result: "*UserRsp", Phase: consts.PHASE_LIST},
							{Enabled: true, Service: false, Payload: "*User", Result: "*User", Phase: consts.PHASE_GET},
						},
						"tenant/users": {
							{Enabled: true, Service: true, Payload: "*UserReq", Result: "*User", Phase: consts.PHASE_CREATE},
							{Enabled: true, Service: true, Payload: "*User", Result: "*User", Phase: consts.PHASE_UPDATE},
							{Enabled: true, Service: true, Payload: "*User", Result: "*User", Phase: consts.PHASE_PATCH},
							{Enabled: true, Service: true, Payload: "*User", Result: "*User", Phase: consts.PHASE_CREATE_MANY},
						},
					},
					Create:     &Action{Enabled: true, Service: false, Public: true, Payload: "User", Result: "*User", Phase: consts.PHASE_CREATE},
					Delete:     &Action{Enabled: true, Service: true, Public: false, Payload: "*User", Result: "*User", Phase: consts.PHASE_DELETE},
					Update:     &Action{Enabled: false, Service: true, Public: false, Payload: "*User", Result: "User", Phase: consts.PHASE_UPDATE},
					Patch:      &Action{Enabled: false, Service: false, Public: false, Payload: "*User", Result: "*User"},
					List:       &Action{Enabled: true, Service: true, Public: false, Payload: "*User", Result: "*User", Phase: consts.PHASE_LIST},
		...
		// 			Param:      ":user",
		// 			Migrate:    false,
		// 			Create:     &Action{Enabled: false, Service: true, Public: false, Payload: "User2", Result: "*User3", Phase: consts.PHASE_CREATE},
		...
		// 			Patch:      &Action{Enabled: true, Service: true, Public: false, Payload: "*User", Result: "User", Phase: consts.PHASE_PATCH},
		...
		// 			Endpoint:   "user",
		// 			Migrate:    false,
		// 			Create:     &Action{Enabled: false, Service: true, Public: false, Payload: "User", Result: "*User", Phase: consts.PHASE_CREATE},
		// 			Delete:     &Action{Enabled: false, Service: false, Public: false, Payload: "*User3", Result: "*User3"},
		// 			Update:     &Action{Enabled: true, Service: true, Public: false, Payload: "*User", Result: "User", Phase: consts.PHASE_UPDATE},
		...
		// 			Endpoint:   "user4",
		// 			Migrate:    false,
		// 			Create:     &Action{Enabled: true, Service: true, Public: false, Payload: "User", Result: "*User", Phase: consts.PHASE_CREATE},
